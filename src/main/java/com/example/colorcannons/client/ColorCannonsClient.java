...
public class ColorCannonsClient {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerEntityRenderer(ModEntities.BLUE_TRACER.get(),
                ctx -> new ColorTracerRenderer<>(ctx, ModColorModes.BLUE));
        event.registerEntityRenderer(ModEntities.RED_TRACER.get(),
                ctx -> new ColorTracerRenderer<>(ctx, ModColorModes.RED));
    }
}

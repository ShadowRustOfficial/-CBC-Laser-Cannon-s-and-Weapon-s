...
public class ModCreativeTabs {
    public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, ColorCannonsMod.MOD_ID);
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB = TABS.register("main", () -> CreativeModeTab.builder()
            ...
            .displayItems((params, output) -> { output.accept(ModItems.LASER_AUTOCANNON_BREECH.get()); output.accept(ModItems.FE_FIXED_CANNON_MOUNT.get()); })
            .build());
}
